package uz.fundgate.valuation.config;
...
/**
 * AWS Bedrock client bean configuration for the valuation module.
...
public class BedrockConfig {
    ...
    public BedrockRuntimeClient bedrockRuntimeClient() {
        log.info("Initializing AWS Bedrock Runtime Client for valuation in region: {}", awsRegion);
        ...
        log.info("AWS Bedrock Runtime Client initialized. Model: {}, Fallback: {}, MaxTokens: {}",
                modelId, fallbackModelId, maxTokens);
        return client;
    }
}
