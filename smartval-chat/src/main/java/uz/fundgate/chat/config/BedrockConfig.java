package uz.fundgate.chat.config;
...
/**
 * AWS Bedrock client configuration for the chat module.
...
public class BedrockConfig {
    ...
    public BedrockRuntimeClient bedrockRuntimeClient() {
        log.info("Initializing AWS Bedrock Runtime Client for chat in region: {}", awsRegion);
